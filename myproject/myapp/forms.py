...
class PersonaForm(forms.ModelForm):
    genero = forms.ChoiceField(choices=[('F', 'Femenino'), ('M', 'Masculino')])
    unidad = forms.ChoiceField(choices=[('Cmd', 'Comando'), ('JEM', 'JEM'), ('IG - FF.AA.', 'IG - FF.AA.'), ('DEPTO I', 'DEPTO I'), ('DEPTO II', 'DEPTO II'), ('DEPTO III', 'DEPTO III'), ('DEPTO IV', 'DEPTO IV'), 
    ...
    certificacion = forms.ChoiceField(choices=[('No Apto', 'No Apto'), ('Apto', 'Apto')])
    test = forms.ChoiceField(choices=[('Positivo', 'Positivo'), ('Negativo', 'Negativo'), ('No Corresponde', 'No Corresponde')])
